...
namespace AWSServerless1.Services
{
    public class EbookService : IEbookService
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "0040434B", RsidRunAdditionDefault = "00D24979", ParagraphId = "12C5A2B5", TextId = "77777777" };

            Run run1 = new Run();
            Text text1 = new Text();
            text1.Text = "This is a test document";
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00D24979" };
            Rsid rsid1 = new Rsid() { Val = "002078C4" };
            Rsid rsid2 = new Rsid() { Val = "00313265" };
            Rsid rsid3 = new Rsid() { Val = "00313D35" };
            Rsid rsid4 = new Rsid() { Val = "00385CFA" };
            Rsid rsid5 = new Rsid() { Val = "004E51DD" };
            Rsid rsid6 = new Rsid() { Val = "005757F3" };
            Rsid rsid7 = new Rsid() { Val = "00602C43" };
            Rsid rsid8 = new Rsid() { Val = "006145FC" };
            Rsid rsid9 = new Rsid() { Val = "00651139" };
            Rsid rsid10 = new Rsid() { Val = "00822A5C" };
            Rsid rsid11 = new Rsid() { Val = "0086658C" };
            Rsid rsid12 = new Rsid() { Val = "00A10B4E" };
            Rsid rsid13 = new Rsid() { Val = "00A12E39" };
            Rsid rsid14 = new Rsid() { Val = "00AF7171" };
            Rsid rsid15 = new Rsid() { Val = "00B26E42" };
            Rsid rsid16 = new Rsid() { Val = "00B54176" };
            Rsid rsid17 = new Rsid() { Val = "00B854E6" };
            Rsid rsid18 = new Rsid() { Val = "00BC0FF6" };
            Rsid rsid19 = new Rsid() { Val = "00D24979" };
            Rsid rsid20 = new Rsid() { Val = "00D5716D" };
            Rsid rsid21 = new Rsid() { Val = "00EE6A7C" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "1F8F22B6" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{45BC334B-CEFD-46BB-A548-FEDB0405F2B1}" };
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2018-11-12T20:52:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2018-11-12T20:52:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
